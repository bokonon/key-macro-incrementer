...
export default class Incrementer {
  ...
  spliceArrayIfNeed(index, stringNumber, number, keyEventArray) {
    // Debug
    for(var i = 0; i < keyEventArray.length; i++) {
      console.log('START keyEventArray[i] : '+keyEventArray[i]);
    }
    console.log('== spliceArrayIfNeed start ==');
    ...
    console.log('== spliceArrayIfNeed end ==');
    // Debug
    for(var i = 0; i < keyEventArray.length; i++) {
      console.log('END keyEventArray[i] : '+keyEventArray[i]);
    }
  }
